...
public class SearchServlet extends HttpServlet {
    ...
    static Logger logger = Logger.getLogger(SearchServlet.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<AccountDTO> dtos = dao.getSearchResult();
            request.setAttribute("SEARCH_RESULT", dtos);
            request.setAttribute("First_Search", true);
        } 
